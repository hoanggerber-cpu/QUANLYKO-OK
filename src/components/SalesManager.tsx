...
export default function SalesManager({ 
  ...
  useEffect(() => {
    ...
    if (prices.length > 0 && !prices.includes(dtfUnitPrice)) {
      setDtfUnitPrice(prices[0]);
    }
  }, [customerName]);
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="min-w-0 flex-1 px-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 text-sm focus:border-blue-500 transition-all font-mono font-bold text-slate-800"
                        />
                        <button
                          type="button"
                        ...
                        <div className="mt-2">
                          ...
                          {savedDtfPrices.length > 0 ? (
                            <div className="flex flex-wrap gap-1.5">
                              {savedDtfPrices.map(price => (
                                <button
                                  key={price}
                                  type="button"
                                  onClick={() => setDtfUnitPrice(price)}
                                  className={`px-2.5 py-1.5 rounded-lg border text-[11px] font-black font-mono transition-colors cursor-pointer ${
                                    dtfUnitPrice === price
